...
## Структура
- `src/` – модули загрузки, оконной нарезки, инференса, визуализации, критериев.
- `notebook/` – блокноты .ipynb с примерами.
- `models/` – обученные модели.
- `time_series/` - примеры временных рядов углов для подачи в модель, из-за ограничения размера загрузки, могу загрузить только сжатые файлы.
